...
CP = /bin/cp
CPP = gcc -std=gnu99 -E
CPPFLAGS = -I/usr/include/openssl  -I/usr/include/tcl8.4
CYGPATH_W = echo
C_CLIENT_CFLAGS = EXTRACFLAGS=" -DTLSV1_2 -I/usr/include/openssl  -I/usr/include/tcl8.4 -g -O2"
C_CLIENT_GCCOPTLEVEL = 
C_CLIENT_LDFLAGS = EXTRALDFLAGS=" -L/usr/lib   -ltcl8.4 -lpam -lssl -lcrypto -ldl  -ltinfo -lpam"
...
LIBINTL = 
LIBOBJS = 
LIBS =  -ltcl8.4 -lpam -lssl -lcrypto -ldl  -ltinfo -lpam
...
PACKAGE_NAME = alpine
PACKAGE_STRING = alpine 2.20.999
PACKAGE_TARNAME = alpine
PACKAGE_URL = 
PACKAGE_VERSION = 2.20.999
PATH_SEPARATOR = :
POSUB = po
