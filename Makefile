...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(top_srcdir)/include/config.h.in ABOUT-NLS README compile \
...
ACLOCAL = ${SHELL} /home/kgeorge/wc/alpine/missing aclocal-1.15
ALPINE_DATESTAMP = Sat Oct 20 04:36:16 EDT 2018
...
AM_LDFLAGS = 
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/kgeorge/wc/alpine/missing autoconf
AUTOHEADER = ${SHELL} /home/kgeorge/wc/alpine/missing autoheader
AUTOMAKE = ${SHELL} /home/kgeorge/wc/alpine/missing automake-1.15
AWK = gawk
BUILD_EXEEXT = 
BUILD_OBJEXT = 
CC = gcc
...
CYGPATH_W = echo
C_CLIENT_AUTHS =  
C_CLIENT_CFLAGS = EXTRACFLAGS=" -I/usr/include/openssl  -g -O2 -DOPENSSL_1_1_0 -DOPENSSL_API_COMPAT=0x10100000L"
C_CLIENT_GCCOPTLEVEL = 
C_CLIENT_LDFLAGS = EXTRALDFLAGS=" -L/usr/lib   -ltcl8.6 -lpam -lssl -lcrypto -ldl  -ltinfo -lpam"
...
LIBINTL = 
LIBOBJS = 
LIBS =  -ltcl8.6 -lpam -lssl -lcrypto -ldl  -ltinfo -lpam
...
MAINT = #
MAKE = /usr/bin/make
MAKEINFO = ${SHELL} /home/kgeorge/wc/alpine/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSGFMT = :
MSGFMT_015 = :
...
PACKAGE_NAME = alpine
PACKAGE_STRING = alpine 2.21.9999
PACKAGE_TARNAME = alpine
PACKAGE_URL = 
PACKAGE_VERSION = 2.21.9999
PATH_SEPARATOR = :
POSUB = po
PTHREAD_CC = gcc
...
XGETTEXT = :
XGETTEXT_015 = :
abs_builddir = /home/kgeorge/wc/alpine
abs_srcdir = /home/kgeorge/wc/alpine
abs_top_builddir = /home/kgeorge/wc/alpine
abs_top_srcdir = /home/kgeorge/wc/alpine
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CC_FOR_BUILD = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
alpine_interactive_spellcheck = /usr/bin/aspell --dont-backup --mode=email check
alpine_simple_spellcheck = /usr/bin/aspell --dont-backup --mode=email list
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/kgeorge/wc/alpine/install-sh
...
gssapi_proxy.l:
	if test ! -L c-client/auth_gss_proxy.c ; then $(LN_S) /home/kgeorge/wc/alpine/web/src/pubcookie/auth_gss_proxy.c c-client/auth_gss_proxy.c ; fi
