...
ALPINE_DATESTAMP = Sun Jan 28 22:35:57 EST 2018
...
AUTOMAKE = ${SHELL} /home/kgeorge/wc/alpine/missing automake-1.13
AWK = gawk
BUILD_EXEEXT = 
BUILD_OBJEXT = 
CC = gcc
...
CP = /bin/cp
CPP = gcc -E
CPPFLAGS = -I/usr/include/openssl -I/data/root/include
CPPFLAGS_FOR_BUILD = 
CPP_FOR_BUILD = gcc -E
CYGPATH_W = echo
C_CLIENT_AUTHS =  
C_CLIENT_CFLAGS = EXTRACFLAGS=" -DTLSV1_2 -I/usr/include/openssl -I/data/root/include -g -O2 -DOPENSSL_1_1_0 -DOPENSSL_API_COMPAT=0x10100000L"
C_CLIENT_GCCOPTLEVEL = 
C_CLIENT_LDFLAGS = EXTRALDFLAGS=" -L/usr/lib -L/data/root/lib  -ltcl8.6 -lpam -lssl -lcrypto -ldl  -ltinfo -lpam"
...
ISPELLPROG = aspell
LD = /usr/bin/ld
LDFLAGS = -L/usr/lib -L/data/root/lib
LDFLAGS_FOR_BUILD = 
LIBICONV = -liconv
LIBINTL = 
LIBOBJS = 
...
PACKAGE_NAME = alpine
PACKAGE_STRING = alpine 2.21.99
PACKAGE_TARNAME = alpine
PACKAGE_URL = 
PACKAGE_VERSION = 2.21.99
PATH_SEPARATOR = :
POSUB = po
PTHREAD_CC = gcc
